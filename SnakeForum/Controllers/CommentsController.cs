...
namespace SnakeForum.Controllers
{
    public class CommentsController : Controller
    {
        ...
        {
            var snakeForumContext = _context.Comment.Include(c => c.Discussion);
            return View(await snakeForumContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("CommentId,Content,Author,CommentDate,DiscussionId")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CommentId,Content,Author,CommentDate,DiscussionId")] Comment comment)
        {
